...
with_node \
  ...
  --target "/Users/haozhen/Desktop/SwipeStyle/ios/Pods/Target Support Files/Pods-OrbitalBlank/ExpoModulesProvider.swift" \
  --platform "apple" \
  --packages "expo-asset" "expo-constants" "expo-eas-client" "expo-file-system" "expo-font" "expo-keep-awake" "expo-router" "expo-updates"
